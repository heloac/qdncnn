...
class DnCNN(nn.Module):
    def __init__(self, depth=17, n_channels=64, image_channels=1, use_bnorm=True, kernel_size=3):
        ...
        for _ in range(depth-2):
            ...
            layers.append(nn.ReLU(inplace=True))
        layers.append(nn.Conv2d(in_channels=n_channels, out_channels=image_channels, kernel_size=self.kernel_size, padding=padding, bias=False))
...
if __name__ == '__main__':
    ...
    for epoch in range(initial_epoch, n_epoch):
        ...
        DLoader = DataLoader(dataset=DDataset, num_workers=4, drop_last=True, batch_size=batch_size,
                             shuffle=True)
        epoch_loss = 0
        ...
        log('epoch = %4d , loss = %4.4f , time = %4.2f s' % (epoch + 1, epoch_loss / len(DLoader), elapsed_time))
